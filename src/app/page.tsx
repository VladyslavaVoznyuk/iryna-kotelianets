          ...
          <section id="services" className="services-section">
              ...
              <div className="services-cards">
                  ...
                  <div className="service-card">
                      ...
                      <h3>Активація енергії Кундаліні</h3>
                      <p>
                  ...
                  <div className="service-card">
                      ...
                      <h3>Тета-Хілінг</h3>
                      <p>
                          Тета-Хілінг - це практичні знання, які дозволяють працювати із своїми підсвідомими програмами на Тета хвилі.
                      </p>
                  ...
                  <div className="service-card">
                      ...
                      <h3>Гра Ліла </h3>
                      <p>
                          Ліла – це глибока духовно-психологічна гра, яка допомогає знайти відповіді на найважливіші запитання, побачити внутрішні ресурси, переконання та подолати свої власні обмеження на шляху до запиту.
                          Можливість подивитись на своє життя зі сторони і згадати, що життя – це гра. Подорож до себе, яка розкриває шляхи до змін та особистісного зростання.</p>
                  ...
                  <div className="service-card">
                      ...
                      <h3>Цвяхостояння </h3>
                      <p>
                          Церемонія цвяхостояння - практика на пізнання себе через чесність та розслаблений стан. Можливість прожити свій біль і знайти внутрішні відповіді на свій запит.
                          Комплексна робота на фізіологічному, духовному (енергетичному) та психологічному рівнях, можливість почути себе без прикрас та масок.</p>
                  ...
                  <div className="service-card">
                      ...
                      <p>
                          За допомогою твоєї дати народження, ти  глибше розкриєш свій потенціал та здібності, дізнаєшся про свої таланти, призначення, зону комфорту, головні уроки по життю.
                          На консультації ми зможемо глибинно пропрацювати будь-яку сферу твого життя, окрім цінної інформації, ти отримаєш заряд енергії та мотивації, яку потім заземлиш в дії за допомогою завдань.</p>
                  </div>
